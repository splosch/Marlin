...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 273.5 // mm was 269

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 178.0 // mm // was 178
  ...
  #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET) + 1.5)
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 230.25 // For delta: Distance between nozzle and print surface after homing.
#endif
...
// default settings
#define E_STEPS_PER_MM 95 // steps per mm
// delta speeds must be the same on xyz
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, E_STEPS_PER_MM}
